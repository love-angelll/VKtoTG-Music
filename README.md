...
Этот проект представляет собой бота ВКонтакте, который принимает музыку, отправленную в личные сообщения группы, и пересылает её в бота Telegram. Бот имеет ограничение для пользователей — до 20 треков в день, но для администратора ограничений нет.
